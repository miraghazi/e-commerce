...
export default function ResetCode() {
    ...
    let valid = Yap.object({
        resetCode : Yap.string().matches(/^[0-9]{6}$/,"Code Is Invalid").required("Code Is Required")
    })
  ...
  return <>
    <div className='mt-10 flex justify-center'><h1 className='text-2xl font-bold pb-1 w-fit relative before:absolute before:bottom-0 before:w-1/2 before:left-1/2 before:-translate-x-1/2 before:h-[4px] before:bg-vip rounded-md text-green-500'>reset your account password</h1></div>
      ...
      <input value={formik.values.resetCode}
             onChange={formik.handleChange}
             onBlur={formik.handleBlur}
            type="tel" name="resetCode" id="resetCode"
  ...
  {formik.errors.resetCode &&formik.touched.resetCode? <div className="flex items-center p-4 mb-4 text-sm text-red-800 border border-red-300 rounded-lg bg-red-50 dark:bg-gray-800 dark:text-red-400 dark:border-red-800" role="alert">
  <svg className="flex-shrink-0 inline w-4 h-4 me-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
    <path d="M10 .5a9.5 9.5 0 1 0 9.5 9.5A9.51 9.51 0 0 0 10 .5ZM9.5 4a1.5 1.5 0 1 1 0 3 1.5 1.5 0 0 1 0-3ZM12 15H8a1 1 0 0 1 0-2h1v-3H8a1 1 0 0 1 0-2h2a1 1 0 0 1 1 1v4h1a1 1 0 0 1 0 2Z"/>
  </svg> {formik.errors.resetCode}</div> :null}
